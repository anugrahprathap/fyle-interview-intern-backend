...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(
            ...
            'Cannot grade an assignment that is in Draft state'
        )
        assertions.assert_valid(
        assignment.teacher_id == auth_principal.teacher_id,'Authenticated teacher is not assigned to this assignment')
    ...
    def get_assignments_by_teacher(cls, teacher_id):
        return cls.query.filter(and_(cls.teacher_id == teacher_id, cls.state != 'DRAFT')).all()
    @classmethod
